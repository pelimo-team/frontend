    ...
    <div className="food-page">
      ...
      <div className="food-content">
        ...
        <div className="food-details">
          ...
          <p className="food-description">{menuItem.description || 'بدون توضیحات'}</p>
          
          <div className="food-price-section">
            {menuItem.onsale && menuItem.sale_price ? (
              <>
                <span className="original-price">{menuItem.price.toLocaleString()} تومان</span>
                <span className="sale-price">{menuItem.sale_price.toLocaleString()} تومان</span>
              </>
            ) : (
              <span className="regular-price">{menuItem.price.toLocaleString()} تومان</span>
            )}
          </div>
        </div>
        ...
        <div className="restaurant-section">
          <div className="restaurant-header">
            ...
            <div className="restaurant-rating">
              <span className="stars">{'⭐'.repeat(Math.round(restaurant.rating || 0))}</span>
