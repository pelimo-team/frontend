...
function HomePage() {
  ...
  const slides = [
    ...
    },
    {
      ...
      description: "Don’t worry — these restaurants stayed open late just for you!🍔✨ Get ready for a delicious midnight bite!",
    ...
    },
    {
      ...
      description: "Let’s play a game! Leave it to luck and pick today’s meal at random!🍱💡 A new flavor every time, a new excitement every time!",
    ...
    <div className={styles["home-container"]}>
      ...
      <header className={styles["home-header"]}>
        ...
        <div className={styles["address-search"]}>
          <img src="search1.png" alt="search" className={styles["magnify-icon1"]} />
          <input type="text" placeholder="Address ..." />
          <img src="mdi_location.png" alt="location" className={styles["loc-icon"]} />
        </div>
        ...
        <div className={styles["search-box"]} ref={searchBoxRef}>
          <img src="search1.png" alt="search" className={styles["magnify-icon2"]} />
          <input
  type="text"
  placeholder="Search ..."
  value={searchText}
...
/>
      ...
      <section className={styles["hero-section"]}>
        <button className={styles["arrow-left"]} onClick={prevSlide}>&lt;</button>
  ...
  <div className={styles.slide} key={idx}>
    <div className={styles["hero-content"]}>
      {slide.title1 && <h1 className={styles.title1}>{slide.title1}</h1>}
      {slide.title2 && <h1 className={styles.title2}>{slide.title2}</h1>}
      {slide.title3 && <h1 className={styles.title3}>{slide.title3}</h1>}
      {slide.title4 && <h1 className={styles.title4}>{slide.title4}</h1>}
    ...
    <div className={styles["hero-image"]}>
      <img src={slide.image} alt={`Slide ${idx + 1}`} />
        ...
        <button className={styles["arrow-right"]} onClick={nextSlide}>&gt;</button>
      </section>
      ...
      <div className={styles["slider-wrapper"]}>
        <button className={styles["arrow-left"]} onClick={prev}>&lt;</button>
        ...
        <button className={styles["arrow-right"]} onClick={next}>&gt;</button>
      </div>
      </section>
